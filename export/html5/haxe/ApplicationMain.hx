...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("haxeFlixel-Practice", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("haxeFlixel-Practice", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "haxeFlixel-Practice";
		app.meta["name"] = "haxeFlixel-Practice";
